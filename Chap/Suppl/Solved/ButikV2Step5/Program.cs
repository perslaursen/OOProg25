...
Kunde k1 = new Kunde(1, "Anne");
Kunde k2 = new Kunde(2, "Bent");
Kunde k3 = new Kunde(3, "Carl");
Kunde k4 = new Kunde(4, "Dina");
Kunde k5 = new Kunde(5, "Erik");
Kunde k6 = new Kunde(6, "Finn");
...
Ordre o1 = new Ordre(p1, 2);
Ordre o2 = new Ordre(p1, 6);
Ordre o3 = new Ordre(p3, 1);
Ordre o4 = new Ordre(p4, 3);
Ordre o5 = new Ordre(p4, 4);
...
foreach (Kunde kunde in kundeListe)
{
	Console.WriteLine(kunde.SomTekstMedDetaljer());
}
